...
class Dcov():
    ...
    nseg=None,imgfmt = 'pdf',fout = 'D_analysis'):
        ...
        self.dt = dt # Trajectory timestep in ps
        self.m = m
        self.tmin = tmin
        self.tmax = tmax
        self.d2max = d2max
        ...
        print(self.z.shape) #Shape (3,N+1)
        ...
        #NO SE PORQUE ESTA CONDICION DE 100 VECES "MENOS"
        ...
        print('Nperseg = {}'.format(self.nperseg))
        if self.nseg == 0:
        ...
        if self.m > self.nperseg:
            ...
            print('Warning: m > Nperseg, falling back to m = {}'.format(self.m))

        #CANVAS OF ZEROS FOR TRAJECTORY
        ...
        with bar.ProgressBar(max_value=self.tmax-self.tmin+1) as progbar:
            for t,step in enumerate(range(self.tmin,self.tmax+1)):
                ...
                for d in range(self.ndim):
                    ...
                    n = len(z) - 1
                    msd = compute_MSD_1D_via_correlation(z)[1:(self.m+1)] # PORQUE SOLO M VALORES DE MSD??
                ...
                print('length N per seg = {} for step {}'.format(n,step))
